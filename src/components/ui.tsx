...
/* viewBox is the path's own measured bounds, not 0 0 24 24. Inside the full
   square this mark filled only 18.58 of 24 vertically, so at a shared size it
   rendered 23% shorter than the Google mark beside it. */
export function AppleGlyph({ size = 19 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="3.97 2.76 14.78 18.58" fill="#172321" aria-hidden>
